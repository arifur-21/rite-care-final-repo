                      ...
                      children: [
                        ...
                        Visibility(
                            ...
                            child: InkWell(
                                onTap: (){
                                  setState(() {
                                    summeryFilterVM.startDate =  DateFormat("yyyy-MM-dd").format(DateTime.now());
                                    summeryFilterVM.endDate =  DateFormat("yyyy-MM-dd").format(DateTime.now());
                                              ...
                                              title: Padding(
                                                ...
                                                child: Container(
                                                  ...
                                                  child: InkWell(
                                                      ...
                                                      child:  Text("${summeryFilterVM.summeryListFilterStatus[index].name}", style: TextStyle(color: statusId == summeryFilterVM.summeryListFilterStatus[index].id ? Colors.red : Colors.black ))),
                                                ),
                                              ),
                                            );
                                          }),
                  ...
                  children: [
                        ...
                        builder: (contxt, data) {
                          return Autocomplete<LabTestNameSuggModel>(
                            optionsBuilder: (TextEditingValue textValue) {
                              summeryFilterVM.getSummeryLabTestNameSuggData(query: textValue.text);
                    ...
                    Row(
                      ...
                      Container(
                        ...
                        height: 40,
                        child: TextFormField(
                          controller:summeryFilterVM.invoNumController.value ,
