...
part of 'parent_patient.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ParentPatient _$ParentPatientFromJson(Map<String, dynamic> json) =>
    ParentPatient(
      oldId: json['OldId'],
      ...
      patientPrefix: json['PatientPrefix'] == null
          ? null
          : PatientPrefix.fromJson(
              json['PatientPrefix'] as Map<String, dynamic>),
      ...
      patientInvoiceShadowId: json['PatientInvoiceShadowId'] as int?,
...
Map<String, dynamic> _$ParentPatientToJson(ParentPatient instance) =>
    <String, dynamic>{
